...
interface CaseStudyCardProps {
  ...
  onNavigate: (route: 'case-study-detail', articleId: string) => void;
  darkTheme?: boolean;
}

export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ article, onNavigate, darkTheme = false }) => {
  // Format date nicely if needed
  const formattedDate = article.publishDate || 'Apr 5, 2025';

  return (
    <div
      onClick={() => onNavigate('case-study-detail', article.id)}
