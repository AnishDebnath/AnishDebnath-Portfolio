...
interface CaseStudyCardProps {
  project: CaseStudy;
  onNavigate: (route: 'case-study-detail', detailId: string) => void;
  index?: number;
}
...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ project, onNavigate, index = 0 }) => {
  ...
  return (
    ...
    >
      ...
      {/* Image Card (Separate card with all 4 corners rounded) */}
      <div className={`lg:col-span-8 rounded-[24px] sm:rounded-[28px] overflow-hidden border border-neutral-800 bg-neutral-900 min-h-[280px] sm:min-h-[340px] lg:min-h-[380px] relative shadow-md ${isReversed ? 'lg:order-1' : 'lg:order-2'}`}>
        <img
