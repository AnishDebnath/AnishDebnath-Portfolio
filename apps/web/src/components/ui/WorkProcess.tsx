                ...
                {steps.map((step, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 relative z-10 shadow-2xs ${isActive
                      ...
                      <div className="flex-1 min-w-0 flex items-center justify-between gap-2.5">
                        <div>
                          <span className={`block font-mono text-[10px] uppercase tracking-wider font-bold mb-0.5 ${isActive ? 'text-[#f2512d]' : 'text-neutral-400'
                            }`}>
                            / {step.tag}
                          </span>
                          <h4 className={`font-sans font-bold text-base sm:text-lg tracking-tight ${isActive ? 'text-[#0d130d]' : 'text-neutral-600'
                            }`}>
                            {step.title}
                          </h4>
                        </div>

                        <span className={`font-mono text-[11px] font-bold shrink-0 px-2.5 py-1 rounded-full border transition-colors ${isActive
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-3 mb-5">
                        <div className="w-10 h-10 rounded-xl bg-[#f5f2eb] border border-neutral-200/80 flex items-center justify-center text-[#0d130d]">
                          {React.cloneElement(currentStep.icon as React.ReactElement<{ className?: string }>, {
