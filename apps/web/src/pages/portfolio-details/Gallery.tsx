        ...
        <section className="py-10 sm:py-16">
            <div className="max-w-[1085px] mx-auto px-4 sm:px-6 space-y-6">
                ...
                <motion.div
                    ...
                    className="rounded-[28px] sm:rounded-[32px] overflow-hidden border border-neutral-300 aspect-[16/9] shadow-md bg-neutral-900"
                >
                    <img
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        {project.galleryImages.slice(1, 3).map((img, idx) => (
                            <motion.div
                                ...
                                className="rounded-[28px] sm:rounded-[32px] overflow-hidden border border-neutral-300 aspect-[4/3] shadow-md bg-neutral-900"
                            >
                                <img
                                    src={img}
