...
import heroPortrait from '../assets/images/hero_portrait_1785396715780.jpg';
    ...
    <section className="pt-14 sm:pt-20 lg:pt-24 pb-8 sm:pb-12 bg-[#f5f5f5] relative overflow-visible">
      <div className="max-w-[1085px] mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative bg-[#f2efe6] bg-hero-grid rounded-[32px] sm:rounded-[40px] md:rounded-[48px] border border-neutral-300 pt-8 sm:pt-12 md:pt-14 pb-8 sm:pb-12 px-6 sm:px-10 md:px-12 lg:px-16 shadow-sm flex flex-col md:flex-row items-stretch justify-between gap-8 md:gap-4 min-h-[420px] sm:min-h-[460px]">
          ...
          <div className="relative md:absolute md:right-4 lg:right-8 md:bottom-0 z-10 w-full md:w-[48%] lg:w-[50%] h-[360px] sm:h-[440px] md:h-[calc(100%+64px)] lg:h-[calc(100%+88px)] flex items-end justify-center md:justify-end pointer-events-none -mt-6 md:mt-0 md:-top-16 lg:-top-22">
            <img
              src={heroPortrait}
              alt="Designer Portrait"
              className="h-full w-auto object-contain object-bottom filter contrast-105 drop-shadow-md select-none pointer-events-none"
              referrerPolicy="no-referrer"
            />
          </div>
